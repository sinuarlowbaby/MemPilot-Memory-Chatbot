...
llm = OpenAI(api_key=os.getenv("OPENAI_API_KEY"), model="gpt-4o", temperature=0.2)
...
def add_knowledge_to_graph(query, ai_response, session_id) -> Optional[bool]:

    doc = Document(text = json.dumps({
        "query": query.strip(),
